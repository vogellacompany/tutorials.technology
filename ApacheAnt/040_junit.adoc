...
Ant allows to run https://www.vogella.com/tutorials/JUnit/article.html[JUnit] tests. 
...
See https://www.vogella.com/tutorials/JUnit/article.html[JUnit Tutorial] for an introduction into JUnit.
