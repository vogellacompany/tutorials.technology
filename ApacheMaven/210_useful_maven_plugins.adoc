...
image::img/maven-dependency-tree-plugin.png[Dependency tree of slf4j-log4j12]
...
image::img/display-dependency-updates.png[﻿The display-dependency-updates goal of the versions maven plugin]
