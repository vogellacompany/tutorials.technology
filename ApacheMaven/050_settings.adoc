[[maven_settings]]
== Maven settings
Maven allows defining settings on a global, user and project level. 
...
image::img/m2e_settings10.png[Maven settings]
	
	
The following _settings.xml_ file defines a proxy server. 
If this snippeted is located in the _.m2_ folder of the users home, Maven uses this proxy.
