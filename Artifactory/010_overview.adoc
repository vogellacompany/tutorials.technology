...
Artifactory is avaalable as https://www.jfrog.com/artifactory/free-trial[Commercial version] and https://www.jfrog.com/open-source/[Open Source distribution].
