...
http://www.groovy-lang.org/[Groovy] is an optionally typed, dynamic language that runs on
the JVM. It is
...
The classical "Hello world" program can be written as a short
Groovy
script.
[source,java]
----
...
* Flexibility - Groovy allows to change classes and methods at
runtime, e.g.
...
* Ease of use - Groovy has list, maps and regular expressions
directly
build
into
the language.

* Simplification in I/O - parsing and creating XML, JSON and
