...
started via the following link: http://localhost:8080/manager/html
...
Web applications may require external libraries. Typically, web
application contain their own libraries but if you want to make
certain libraries available for all applications you can put them
into
the
folder
"lib" and a subfolder below "lib". These libraries are
then available
for all web
applications.
