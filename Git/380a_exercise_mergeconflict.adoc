...
[source,terminal]
----
include::./examples/merge/createconflict1.txt[]
---- [source,terminal]
----
include::./examples/merge/createconflict2.txt[]
----
 [source,terminal]
----
include::./examples/merge/createconflict3.txt[]
----
 As this push
...
[source,terminal]
----
include::./examples/merge/createconflict4.txt[]
...
[source,terminal]
----
include::./examples/merge/createconflict5.txt[]
---- This creates the conflict and a message similar to the following.

[source,terminal]
----
include::./examples/merge/createconflict7.txt[]
...
[source,terminal]
----
include::./examples/merge/mergeconflict.txt[]
...
[source,terminal]
----
include::./examples/merge/mergeconflictsolved.txt[]
----
 Afterwards add
...
[source,terminal]
----
include::./examples/merge/createconflict6.txt[]
