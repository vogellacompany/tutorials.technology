...
[source,terminal]
----
include::./examples/remotebranch/showremotes.txt[]
----

To update
remote-tracking branches without changing local branches you use the
`git fetch` command which is covered in <<gitfetch>>.
...
It is safe to delete a remote branch in your local Git repository. You can use the
following command for that.

[source,terminal]
----
include::./examples/remotebranch/delete.txt[]
---- 
...
[source,terminal]
----
include::./examples/remotebranch/deleteremotebranch.txt[]
----

For example if you want to delete the branch called _testbranch_ in the
remote repository called _origin_ you can use the following command.

[source,terminal]
----
include::./examples/remotebranch/deleteremotebranch3.txt[]
----
 > *Note*
...
Tracking branches_ allow you to use the `git pull` and `git push`
...
[source,terminal]
----
include::./examples/remotebranch/trackingbranch.txt[]
----
 Instead of
...
[source,terminal]
----
include::./examples/remotebranch/create.txt[]
...
[source,terminal]
----
include::./examples/remotebranch/update.txt[]
---- 
...
[source,terminal]
----
include::./examples/remotebranch/showtrackingbranches.txt[]
----
...
[source,terminal]
----
include::./examples/remotebranch/output.txt[]
----
