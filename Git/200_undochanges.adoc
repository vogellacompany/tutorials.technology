...
staged changes"LARSSECONDARY (((Remove staged changes from
the staging area)))
...
[source,terminal] ----
include::./examples/deletefile/stageunwantedchanges.txt[] ---- The
output of `git status` command should look similar to the following.
...
[source,terminal] ---- include::./examples/deletefile/unstage.txt[] ----
Use the `git status` command to see the result.

[source,terminal] ----
include::./examples/deletefile/unstage_result.txt[] ---- The `git reset`
...
[source,terminal] ---- include::./examples/delete/git_checkoutfile.txt[]
---- For example, you can restore the content of a directory called
`data` with the following command.

[source,terminal] ----
include::./examples/delete/restoredir_notstaged.txt[] ---- ## Remove
changes in the working tree and the staging area
\{#undochanges_directorydeletion}

((git checkout))
 LARSSECONDARY"undo staged
changes"LARSSECONDARY (((Undo staged
changes)))
...
[source,terminal] ---- include::./examples/delete/restoredir.txt[] ----
...
[source,terminal] ---- include::./examples/commandline/git_revert[] ----
