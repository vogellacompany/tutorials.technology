...
[source,console]
----
include::./examples/commandline/git_merge[]
----
...
[source,console]
----
include::./examples/merge/mergeours.txt[]
----
...
[source,console]
----
include::./examples/merge/mergeoctupus.txt[]
----
...
[source,console]
----
include::./examples/merge/mergeours2.txt[]
----
