...
[source,terminal]
----
include::./examples/fetch/fetch.txt[]
----
 The
...
[source,terminal]
----
include::./examples/remote/gitupdate.txt[]
----
...
[source,terminal]
----
include::./examples/remotebranch/compare.txt[]
...
[source,terminal]
----
include::./examples/remotebranch/apply.txt[]
----
...
((Fetch compared with pull))
The `git pull` command performs a `git fetch` and `git merge` (or
