...
You can set the `scanForTestClasses` property to false, if you do not want automatic test class detection.
In this case, if no additional include / exclude patterns are specified, the default for included classes are **/*Tests.class”, “**/*Test.class” and the default excluded classes are “**/Abstract*.class”.
