...
In a _build.gradle_file in the root_project general configurations can be applied to all projects or just to the sub projects.
...
The `core`, `ui` and `util` sub projects can also have their own _build.gradle_file.
