...
----
image::vogellacompany.jpg[vogella Logo]
----
...
In order to add special asciidoc elements as lists, Keyboard shortcuts, buttons within a table cell just add an `a` before the `|`.
...
|===
|Keyboard shortcuts |List |Button 
