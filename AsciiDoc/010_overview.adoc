...
NOTE: If the images are located in a certain directory, you can specify this folder in the header of your document via the following:
...
----
image::vogellacompany.jpg[vogella Logo,pdfwidth=60%]
----

Unfortunately it is currently not possible to define a default scale factor, see https://github.com/asciidoctor/asciidoctor-pdf/issues/455.
