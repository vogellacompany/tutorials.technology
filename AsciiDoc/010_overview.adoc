...
<3> by default, the TOC will get the title "Table of Contents", you can set a customized name with the toc-title attribute. 
...
<7> Defines the default image location
