...
You can define menus and buttons with the following syntax. This requires the activation of an experimental feature in Asciidoctor and I have no idea how to do that.
----
